define(["require", "exports", "tslib", "./Panel.types", "../../Styling", "../../Utilities"], function (require, exports, tslib_1, Panel_types_1, Styling_1, Utilities_1) {
    "use strict";
    ...
    exports.getStyles = function (props) {
        ...
        var windowHeight = typeof win !== 'undefined' ? win.innerHeight : '100%';
        return {
            root: [
                classNames.root,
                theme.fonts.medium,
            ...
            header: [
                ...
                sharedPaddingStyles,
                {
                    ...
                    flexGrow: 0,
                    selectors: (_f = {},
                        _f["@media (min-width: " + Styling_1.ScreenWidthMinXLarge + "px)"] = {
                            marginTop: '30px'
                        },
                        _f)
                }
